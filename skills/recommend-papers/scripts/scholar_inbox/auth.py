...
Copyright (c) 2026 Jiahao Shao). See ../THIRD_PARTY_LICENSES. Unmodified.
...
def open_browser_for_login() -> str | None:
    ...
    print("\nCould not auto-extract cookie. Get it manually from DevTools → "
          "Network → any scholar-inbox.com request → Cookie: session=...", file=sys.stderr)
    try:
