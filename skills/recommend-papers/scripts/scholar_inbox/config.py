"""Scholar Inbox session/config storage (stdlib only).

Adapted from https://github.com/jiahao-shao1/sjh-skills (MIT License,
Copyright (c) 2026 Jiahao Shao). See ../THIRD_PARTY_LICENSES.
Local edit: default config dir moved under scholar-workflow's config home so
the session cookie lives alongside the plugin's other env state.
"""
...
DEFAULT_DIR = Path.home() / ".config" / "scholar-workflow" / "scholar-inbox"
